                ...
                <View className="mt-4 flex-row items-center justify-between">
                    {data?.rating && (
                        <View className=" flex-row items-center space-x-2">
                            ...
                            <View>
                                <Text className="text-[#515151] text-[10px]">{data?.rating}</Text>
                                <Text className="text-[#515151] text-[10px]">Ratings</Text>
                            </View>
                        </View>
                    )}
                    ...
                    {data?.price_level && (
                        <View className=" flex-row items-center space-x-2">
                            ...
                            <View>
                                <Text className="text-[#515151] text-[10px]">{data?.price_level}</Text>
                                <Text className="text-[#515151] text-[10px]">Price Level</Text>
                            </View>
                        </View>
                    )}
                    ...
                    {data?.bearing && (
                        <View className=" flex-row items-center space-x-2">
                            ...
                            <View>
                                <Text className="text-[#515151] capitalize text-[10px]">
                                    {data?.bearing}
                                </Text>
                                <Text className="text-[#515151] text-[10px]">Bearing</Text>
                            </View>
                        </View>
                    )}
                </View>
